					...
					<div class="card-body">
                       ...
                       @csrf 
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" id="nombre_empleado" name="nombre_empleado" value="{{ old('nombre_empleado',$empleado->nombre_empleado) }}"/>
								</div>
							</div>
							<!--RFC-->
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" id="RFC" name="RFC" value="{{ old('RFC',$empleado->RFC) }}"/>
								</div>
							</div>
							<!--puesto-->
							<div class="form-group row">
							...
							<div class="form-group row">
								<div class="col-sm-9 offset-sm-4">
									<button type="submit" class="btn btn-primary" name="registrar" value="registrar">Editar</button>
								</div>
							</div>
						</form>
					</div>
